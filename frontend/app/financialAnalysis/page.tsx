    ...
    <main className="flex flex-1 flex-col items-center justify-start w-full p-4">
      <section className="w-full max-w-3xl space-y-6">
        <button
          ...
          disabled={loading}
          className="px-5 py-2 rounded bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-base font-semibold"
        >
          {loading ? 'Loading... This may take a while' : 'Start Financial Analysis'}
        </button>
        {analysis && (
